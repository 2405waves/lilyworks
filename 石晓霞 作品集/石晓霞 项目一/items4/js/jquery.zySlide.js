...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 120, height: 150, top: 71, left: 162, opacity: 0},            
            { '&zIndex': 2, width: 162, height: 267, top: 23, left: 0,   opacity: 0.7 },//第一张图
            { '&zIndex': 3, width: 189, height: 304, top: 12, left: 172, opacity: 0.8 },
            { '&zIndex': 4, width: 205, height: 336, top: 0,  left: 371, opacity: 1   },
            { '&zIndex': 3, width: 189, height: 304, top: 12, left: 586, opacity: 0.8 },
            { '&zIndex': 2, width: 162, height: 267, top: 23, left: 785, opacity: 0.7 },//第五张图
            { '&zIndex': 1, width: 120, height: 150, top: 71, left: 700, opacity: 0}
            //left移动距离=上一个图片的width+加间距，（注意间距要累加不能只加一次）
        ]
